...
A TypeScript SDK for running AI coding agents (Amp, Claude, Codex, Gemini, Goose, Letta, OpenCode, Pi) in secure [Daytona](https://daytona.io) sandboxes. Designed for background execution with polling-based event streaming.
...
|----------|--------|------|
| [Amp](https://ampcode.com) | ✅ | `AMP_API_KEY` |
...
| [Letta](https://docs.letta.com) | ✅ | `LETTA_API_KEY` |
...
| Letta | `letta --new --input-format stream-json --output-format stream-json --yolo -p "prompt"` |
...
|----------|---------|------|
| **Amp** | `model: "claude-sonnet-4-5"` | [Amp Code models](https://ampcode.com/docs) |
...
| **Letta** | `model: "gpt-4o"` | [Letta models](https://docs.letta.com) |
