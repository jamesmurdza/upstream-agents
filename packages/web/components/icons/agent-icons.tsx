...
// ClauRST icon - Rust gear with Anthropic styling
// ClauRST is a Rust reimplementation of Claude Code
export function ClaurstIcon({ className }: AgentIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      {/* Rust gear icon */}
      <path
        d="M23.8346 11.7033l-1.0073-.6236a1.4224 1.4224 0 0 1-.5369-.5765 1.4167 1.4167 0 0 1-.1638-.7514l.0246-1.1703a.3875.3875 0 0 0-.2144-.357l-1.0614-.4817a.3875.3875 0 0 0-.4143.0676l-.8407.8532a1.4167 1.4167 0 0 1-.7107.3871 1.4167 1.4167 0 0 1-.7853-.0874l-1.0935-.4461a.3875.3875 0 0 0-.3982.0975l-.6236 1.0073a.3875.3875 0 0 0 .0167.4234l.6804.9233a1.4167 1.4167 0 0 1 .2716.7334 1.4167 1.4167 0 0 1-.1783.7664l-.5413 1.0253a.3875.3875 0 0 0 .1178.4818l1.0614.4817a.3875.3875 0 0 0 .4143-.0676l.8407-.8532a1.4167 1.4167 0 0 1 .7107-.3871 1.4167 1.4167 0 0 1 .7853.0874l1.0935.4461a.3875.3875 0 0 0 .3982-.0975l.6236-1.0073a.3875.3875 0 0 0-.0167-.4234l-.6804-.9233a1.4167 1.4167 0 0 1-.2716-.7334 1.4167 1.4167 0 0 1 .1783-.7664l.5413-1.0253a.3875.3875 0 0 0-.1178-.4818zM12 15.75a3.75 3.75 0 1 1 0-7.5 3.75 3.75 0 0 1 0 7.5zm0-6a2.25 2.25 0 1 0 0 4.5 2.25 2.25 0 0 0 0-4.5zM6.1654 11.7033l-1.0073-.6236a1.4224 1.4224 0 0 1-.5369-.5765 1.4167 1.4167 0 0 1-.1638-.7514l.0246-1.1703a.3875.3875 0 0 0-.2144-.357l-1.0614-.4817a.3875.3875 0 0 0-.4143.0676l-.8407.8532a1.4167 1.4167 0 0 1-.7107.3871 1.4167 1.4167 0 0 1-.7853-.0874L.3617 8.5172a.3875.3875 0 0 0-.3982.0975l-.6236 1.0073a.3875.3875 0 0 0 .0167.4234l.6804.9233a1.4167 1.4167 0 0 1 .2716.7334 1.4167 1.4167 0 0 1-.1783.7664l-.5413 1.0253a.3875.3875 0 0 0 .1178.4818l1.0614.4817a.3875.3875 0 0 0 .4143-.0676l.8407-.8532a1.4167 1.4167 0 0 1 .7107-.3871 1.4167 1.4167 0 0 1 .7853.0874l1.0935.4461a.3875.3875 0 0 0 .3982-.0975l.6236-1.0073a.3875.3875 0 0 0-.0167-.4234l-.6804-.9233a1.4167 1.4167 0 0 1-.2716-.7334 1.4167 1.4167 0 0 1 .1783-.7664l.5413-1.0253a.3875.3875 0 0 0-.1178-.4818z"
        fill="currentColor"
      />
    </svg>
  )
...
export function AgentIcon({ agent, className }: { agent: Agent; className?: string }) {
  switch (agent) {
    ...
    case "claurst":
      return <ClaurstIcon className={className} />
    case "codex":
